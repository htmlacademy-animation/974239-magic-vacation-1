...
/*!*************************************************!*\
  !*** ./source/js/modules/animate-typography.js ***!
  \*************************************************/
/*! exports provided: animateTypography */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const animateTypography = (selector, options = defaultOptions) => {
...
/***/ "./source/js/modules/animatePagesTypography.js":
/*!*****************************************************!*\
  !*** ./source/js/modules/animatePagesTypography.js ***!
  \*****************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _animate_typography__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./animate-typography */ "./source/js/modules/animate-typography.js");


/* harmony default export */ __webpack_exports__["default"] = (() => {
  const runIntroTitle = Object(_animate_typography__WEBPACK_IMPORTED_MODULE_0__["animateTypography"])(`.intro__title`, {delayAnimationByWord: true});
  const runIntroDate = Object(_animate_typography__WEBPACK_IMPORTED_MODULE_0__["animateTypography"])(`.intro__date`);
  const runSliderItemTitle = Object(_animate_typography__WEBPACK_IMPORTED_MODULE_0__["animateTypography"])(`.slider__item-title`);
  const runPrizesTitle = Object(_animate_typography__WEBPACK_IMPORTED_MODULE_0__["animateTypography"])(`.prizes__title`);
  const runRulesTitle = Object(_animate_typography__WEBPACK_IMPORTED_MODULE_0__["animateTypography"])(`.rules__title`);
  const runGameTitle = Object(_animate_typography__WEBPACK_IMPORTED_MODULE_0__["animateTypography"])(`.game__title`);
...
class FullPageScroll {
  ...
  changeVisibilityDisplay() {
    ...
    const prevActiveScreen = Array.from(this.screenElements).find((screen) => screen.classList.contains(`active`));
    const prevActiveScreenId = prevActiveScreen ? prevActiveScreen.id : null;

    const shouldSetTransition = prevActiveScreenId === `story`;

    this.screenElements.forEach((screen) => {
      if (shouldSetTransition && screen.id === `story`) {
        setTimeout(() => {
...
/* harmony import */ var _modules_animatePagesTypography__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/animatePagesTypography */ "./source/js/modules/animatePagesTypography.js");
// modules
...
Object(_modules_animatePagesTypography__WEBPACK_IMPORTED_MODULE_9__["default"])();
